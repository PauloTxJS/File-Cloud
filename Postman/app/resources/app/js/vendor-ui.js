...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__postman_sanitise_user_content__ = __webpack_require__(1252);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_DashboardService__ = __webpack_require__(106);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_messaging_Toast__ = __webpack_require__(3663);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__stores_store_handler__ = __webpack_require__(3665);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(_) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__controllers_Shortcuts__ = __webpack_require__(1616);
...
var UIZoom = __WEBPACK_IMPORTED_MODULE_1_backbone___default.a.Model.extend({
  ...
  _loadZoomLevel: function () {
    let zoomLevel = this._normalizeZoomLevel(pm.settings.getSetting('uiZoom'));
  ...
  /**
      * In Postman v7.22.0 we had changed the zoom scale. Due to lack of any migration,
      * the old and new zoom levels were not compatible
      * Incident: https://postmanlabs.atlassian.net/wiki/spaces/INCD/pages/1956776911
      * This could lead to having zoom levels which are above the valid limits for the old app
      * Valid zoom levels in apps before v7.22.0 were in range [-10, 10]
      * The new zoom levels introduced in v7.22.0 were in range [0, 16]
      * The zoom levels from 11-16 are not valid for the old apps. This won't the user to increase or
      * decrease the zoom and they would be stuck on that zoom level.
      *
      * Since we had reverted the change, we need to make sure that the new zoom levels
      * are normalized within valid range
      * @param {Number} zoomLevel
      */
  _normalizeZoomLevel: function (zoomLevel) {
    // For invalid zoom levels set to default
    if (!Number.isInteger(zoomLevel)) {
      return 0;
    }

    // Otherwise normalize to nearest supported zoom level
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__controllers_theme_ThemeDomDelegator__ = __webpack_require__(3679);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ShortcutsList__ = __webpack_require__(1674);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__constants_SettingsTypeConstants__ = __webpack_require__(756);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_EditorService__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_WorkspaceViewModeService__ = __webpack_require__(1076);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__api_dev_services_SaveAsNewAPIService__ = __webpack_require__(426);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__modules_view_manager_ActiveViewManager__ = __webpack_require__(764);
var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants_DefaultShortcutConstants__ = __webpack_require__(3654);
var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__base_Icons_InformationIcon__ = __webpack_require__(196);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ThemeHelpers__ = __webpack_require__(3680);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__themes_design_system_light_json__ = __webpack_require__(3681);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__themes_design_system_dark_json__ = __webpack_require__(3682);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__themes_light_json__ = __webpack_require__(3683);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__themes_dark_json__ = __webpack_require__(3684);
