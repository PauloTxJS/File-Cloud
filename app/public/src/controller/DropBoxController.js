class DropBoxController {
    ...
    connectFirebase() {
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyAIzPfZJEqgZqcjCutUv8OhbSav32sJFvw",
            authDomain: "dropboxclone-c9a85.firebaseapp.com",
            databaseURL: "https://dropboxclone-c9a85.firebaseio.com",
            projectId: "dropboxclone-c9a85",
            storageBucket: "dropboxclone-c9a85.appspot.com",
            messagingSenderId: "279111056544",
            appId: "1:279111056544:web:c3a8c724efddf681b39dc5"
        };
        // Initialize Firebase
    ...
    readFiles() {
        ...
        this.getFirebaseRef().on('value', anapshot => {

            this.listFilesEl.innerHTML = '';

            anapshot.forEach(snapshotItem => {
